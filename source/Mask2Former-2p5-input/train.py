...
from mask2former.data.dataset_mappers.two_point_five_d import TwoPointFiveDInferenceDatasetMapper
...
class Trainer(DefaultTrainer):
    ...
    def build_test_loader(cls, cfg, dataset_name):
        if cfg.INPUT.USE_2P5D:
            return build_detection_test_loader(
                cfg,
                dataset_name,
                mapper=TwoPointFiveDInferenceDatasetMapper(cfg),
            )
