...
# Set default scope to mmdet to fix registry issues
default_scope = 'mmdet'

# Standalone Mask R-CNN config for VerSe
model = dict(
    type='MaskRCNN',
...
param_scheduler = [
    ...
    dict(type='MultiStepLR', milestones=[16000, 19000], gamma=0.1, by_epoch=False)
]
...
log_level = 'INFO'
load_from = 'instance/mmdetection/weights/mask_rcnn_r50_fpn_1x_coco_20200205-d4b0c5d6.pth'
resume = False
